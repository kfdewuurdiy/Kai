...
MinimizeButton.MouseButton1Click:Connect(function()
    ...
    MinimizedImageButton.Visible = true
end)

local MinimizedImageButton = Instance.new("ImageButton")
MinimizedImageButton.Parent = ScreenGui
MinimizedImageButton.Image = "rbxassetid://17800120247"
MinimizedImageButton.BackgroundTransparency = 1
MinimizedImageButton.Size = UDim2.new(0, 50, 0, 50)
MinimizedImageButton.Position = UDim2.new(0, 10, 0, 10) -- Posição no canto superior esquerdo
MinimizedImageButton.Visible = false
MinimizedImageButton.MouseButton1Click:Connect(function()
